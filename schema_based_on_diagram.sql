...
CREATE INDEX history_treatments_history_id_idx ON history_treatments_join(medical_history_id),
CREATE INDEX history_treatments_treatment_id_idx ON history_treatments_join(treatments_id)